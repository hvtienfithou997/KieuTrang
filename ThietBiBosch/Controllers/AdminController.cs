...
namespace ThietBiBosch.Controllers
{
    ...
    public class AdminController : BaseController
    {
        ...
        public ActionResult AddUser()
        {
            ...
            ViewBag.GetQuyen = db.PhanQuyens.ToList();
            return View();
        }

        [HttpPost]
        public ActionResult AddUser(TaiKhoan tk, string quyen)
        {
            ...
            CreateQuyen(quyen, id);

            return RedirectToAction("PhanQuyenNguoiDung", "PhanQuyen");
        }


        // Sửa tài khoản trong hệ thống
        ...
        private void CreateQuyen(string id_quyen, string maTk)
        {
            ChiTietQuyen ct = new ChiTietQuyen();
            ct.id_pq = Guid.NewGuid().ToString();
            ct.id_quyen = id_quyen;
            ct.MaTaiKhoan = maTk;
            db.ChiTietQuyens.Add(ct);
            db.SaveChanges();
        }
